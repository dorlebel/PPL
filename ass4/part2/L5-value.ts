...
import { isPrimOp, CExp, PrimOp, VarDecl, isValuesExp } from './L5-ast';
...
export type SExpValue = number | boolean | string | PrimOp | Closure | SymbolSExp | EmptySExp | Tuple | CompoundSExp | void;
...
export const makeTuple = (vls: SExpValue[],): Tuple =>
    ({tag: "Tuple", vals: vls});
